...
import com.example.manager.admin.TeacherManager;
...
public class TeacherService extends BaseService {
    ...
    public ResultVO update(TeacherEntity entity) {
        ...
        if (originEntity == null) {
            return failedResult("教师 " + entity.getId() + "不存在!");
        }
        if (manager.getDepartmentById(entity.getDepartmentId()) == null) {
            return failedResult("所属系 " + entity.getDepartmentId() + "不存在!");
        }
    ...
    public ResultVO create(TeacherEntity entity) {
        if (manager.getByNumber(entity.getNumber()) != null) {
            return failedResult("教师 " + entity.getNumber() + "已存在！");
        }
        if (manager.getDepartmentById(entity.getDepartmentId()) == null) {
            return failedResult("所属系 " + entity.getDepartmentId() + "不存在!");
        }
