...
import com.example.manager.admin.AdminManager;
...
public class AdminService extends BaseService {
    ...
    public ResultVO get(Long id) {
        ...
        if (entity == null) {
            return failedResult("管理员: " + id + "不存在!");
        }
    ...
    public ResultVO update(AdminEntity entity) {
        ...
        if (originEntity == null) {
            return failedResult("管理员: " + entity.getId() + "不存在!");
        }
    ...
    public ResultVO create(AdminEntity entity) {
        if (manager.getByUsername(entity.getUsername()) != null) {
