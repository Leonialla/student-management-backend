...
import com.example.manager.admin.StudentCourseManager;
...
public class StudentCourseService extends BaseService {
    ...
    public ResultVO get(Long id) {
        ...
        if (entity == null) {
            return failedResult("学生选课 " + id + "不存在!");
        }
    ...
    public ResultVO update(StudentCourseEntity entity) {
        ...
        if (originEntity == null) {
            return failedResult("学生选课 " + entity.getId() + "不存在!");
        }
    ...
    public ResultVO create(StudentCourseEntity entity) {
        if (manager.get(entity.getId()) != null) {
            return failedResult("学生选课 " + entity.getId() + "已存在!");
        }
        if (manager.getStudentById(entity.getStudentId()) == null) {
            return failedResult("所属学生 " + entity.getStudentId() + "不存在!");
        }
        ...
        if (course == null) {
            return failedResult("所属课程 " + entity.getCourseId() + "不存在!");
        }
